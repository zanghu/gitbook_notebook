...
* [Python](python/README.md)
  ...
  * [Python: Jupyter Notebook](python/jupyter/README.md)
    * [jupyter: 搭建 sevrer（非SSL方式）](python/jupyter/python015.md)
    * [jupyter: 搭建 sevrer（SSL方式）](python/jupyter/python016.md)
    * [jupyter: 服务器快速配置](python/jupyter/python006.md)
    * [jupyter: 自定义配置](python/jupyter/python049.md)
    * [jupyter: 常用命令](python/jupyter/python059.md)
    * [jupyter: 下载服务器数据](python/jupyter/python058.md)
  * [Python: 技巧](python/basic/README.md)
    * [关于函数定义形参表的形参前面的星号和双星号](python/basic/python001.md)
    * [查看对象的成员是方法还是属性](python/basic/python060.md)
    * [查看对象的父类](python/basic/python062.md)
  ...
  * [Python: 模块学习](python/module/README.md)
    ...
    * [pandas](python/module/pandas/README.md)
      ...
      * [pandas: DF改变列顺序](python/module/pandas/python055.md)
  ...
  * [Python: C/C++扩展Python](python/c_cpp_python_extension/README.md)
...
* [EDA](eda/README.md)
  ...
  * [算法模型](eda/model/README.md)
    ...
    * [xgboost](eda/model/xgboost/README.md)
    * [catboost](eda/model/xgboost/README.md)
* [CV](cv/README.md)
...
* [推荐系统](recsys/README.md)
  * [数据采集](recsys/collection/README.md)
    * [埋点、无埋点和全埋点](recsys/collection/rs001.md)
    * [PV、UV、VV、IP的区别](recsys/collection/rs002.md)
    * [Web App和Native App的区别](recsys/collection/rs003.md)
...
* [数学与统计](math/README.md)
  * [Statistics](math/statistics/README.md)
    ...
    * [统计学概念: CDF、KDE、ECDF](math/statistics/math004.md)
    * [统计学概念: 条件数](math/statistics/math005.md)
* [Linux/Unix](linux/README.md)
  * [深入内核](linux/kernel/README.md)
    ...
    * [并发编程: 指令重排](linux/kernel/lin110.md)
  ...
  * [软件安装](linux/soft_setup/README.md)
    ...
    * [Linux: 安装MySQL（Ubuntu）](linux/soft_setup/lin052.md)
...
* [C](c/README.md)
  * [知识与经验](c/basic/README.md)
    ...
    * [指针强制转换分析01](c/basic/c052.md)
    * [指针强制转换分析02](c/basic/c072.md)
    ...
    * [C语言中“常量表达式”的理解](c/basic/c071.md)
  ...
  * [命令行工具](c/tools/README.md)
    * [安装C/C++ man page](linux/soft_setup/lin040.md)
...
* [C++](c++/README.md)
  * [C++: 安装C/C++ man page](linux/soft_setup/lin040.md)
  * [C++: 模板元编程](c++/cpp001.md)
...
* [Java](java/README.md)
  ...
  * [Maven](java/maven/README.md)
    ...
    * [Maven: groupId和artifactId](java/maven/java011.md)
* [数据库](database/README.md)
  ...
  * [Oracle](database/oracle/README.md)
    ...
    * [Oracle: 常用查询命令](database/oracle/db005.md)
...
* [网络](network/README.md)
  ...
  * [HTTP: multipart/form-data](network/network009.md)
...
* [前端](front/README.md)
  ...
  * [JS: 为什么执行JS脚本最后输出undefined](front/front002.md)
  * [JS: Chrome执行JS脚本的简单方法](front/front004.md)
  * [JS: 变量声明提升](front/front005.md)
